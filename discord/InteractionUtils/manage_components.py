...
async def wait_for_component(client: discord.Client, messages: typing.Union[discord.Message, int, list] = None, components: typing.Union[str, dict, list] = None, check=None, timeout=None) -> ComponentContext:
    """
