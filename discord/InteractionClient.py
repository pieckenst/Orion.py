#wip for a custom interaction client
#a better name will need to be made.
...
from . import context, error, http, model, Forbidden, HTTPException, Guild, NotFound, Client
...
class InteractionClient:
    ...
    def add_interaction(
        ...
        permissions: Dict[int, list] = None,
        connector: dict = None,
    ...
    def add_subcommand(
        ...
        base_permissions: Dict[int, list] = None,
    ...
    def add_component_callback(
        ...
        callback: Coroutine,
        *,
        messages: Union[int, Message, list] = None,
