...
Message.Message.__new__ = new_override
...
async def send(self, content=None, *, tts=False, embed=None, file=None, components=None, files=None, delete_after=None, nonce=None, allowed_mentions=None, reference=None, mention_author=None):
    """|coro|
    ...
    **Specifying both parameters will lead to an exception**.
    ...
    allowed_mentions: :class:`~discord.AllowedMentions`
        ...
        are used instead.
        .. versionadded:: 1.4
    reference: Union[:class:`~Message`, :class:`~MessageReference`]
