...
extlinks = {
    'issue': ('https://discord.gg/RqzbB4hE6p', 'GH-'),
}
...
html_context = {
  'discord_invite': 'https://discord.gg/RqzbB4hE6p',
  'discord_extensions': [
...
def setup(app):
  if app.config.language == 'ja':
    ...
    app.config.html_context['discord_invite'] = 'https://discord.gg/RqzbB4hE6p'
    app.config.resource_links['discord'] = 'https://discord.gg/RqzbB4hE6p'
